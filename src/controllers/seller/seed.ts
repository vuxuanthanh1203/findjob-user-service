...
import { BadRequestError, IBuyerDocument, IEducation, IExperience, ISellerDocument } from '@vuxuanthanh1203/findjob-helpers-lib';
...
const seed = async (req: Request, res: Response): Promise<void> => {
  ...
  for (let i = 0; i < buyers.length; i++) {
    ...
    const seller: ISellerDocument = {
      ...
      socialLinks: ['https://www.instagram.com', 'http://www.youtube.com', 'https://www.facebook.com'],
      certificates: [
        {
